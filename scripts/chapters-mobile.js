                ...
                for (var i=0; i<chapters.length; i+=4) {
                    ...
                    while (j > 0) {
                        ...
                        items += "<div style=\"display: flex; flex-flow: row nowrap; margin-top: 5px;\" class=\"chapter-link\">\n" +
                            "<a onclick=\"return false;\" href='http://localhost/quiz/rules-mobile.html?course-id="+courseId+"&chapter-id="+chapter.id+"' style=\"text-decoration: none; color: black;\">"+name+"</a>\n" +
                            "</div>";
                        k++;
                        j--;
                        len--;
